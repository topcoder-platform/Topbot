module.exports = {
  TEAM_TO_POST: '', //The id of the team where your requests and tasks will be posted
  CHANNEL_TO_POST: '', // The id of the channel to post requests
  CHANNEL_TO_POST_TASKS: '', // The name of the channel to post launched tasks 
